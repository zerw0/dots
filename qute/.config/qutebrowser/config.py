...
c.url.searchengines = {'DEFAULT': 'https://duckduckgo.com/?q={}', 'am': 'https://www.amazon.com/s?k={}', 'aw': 'https://wiki.archlinux.org/?search={}', 'goog': 'https://www.google.com/search?q={}', 'hoog': 'https://hoogle.haskell.org/?hoogle={}',
                       're': 'https://www.old.reddit.com/r/{}', 'ub': 'https://www.urbandictionary.com/define.php?term={}', 'wiki': 'https://en.wikipedia.org/wiki/{}', 'yt': 'https://www.youtube.com/results?search_query={}'}
...
config.bind(',odl', 'spawn --userscript open_download')
config.bind('ch', 'history-clear')

# mpv binds
config.bind(',m', 'spawn umpv {url}')
config.bind(',M', 'hint links spawn --detach umpv {hint-url}')
config.bind(';M', 'hint --rapid links spawn --detach umpv {hint-url')
